<?php
/* Spacer */
function elito_spacer_function($atts, $content = true) {
...
add_shortcode("elito_spacer", "elito_spacer_function");

/* Social Icons */
function elito_socials_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "social_select" => '',
    "custom_class" => '',
    "section_title" => '',
  ...
  if ( $icon_color || $icon_size ) {
    ...
    $inline_style .= ( $icon_size ) ? 'font-size:'. elito_core_check_px($icon_size) .';' : '';
    $inline_style .= '}';
  }
...
add_shortcode("elito_socials", "elito_socials_function");

/* Social Icon */
function elito_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_link" => '',
      "social_icon" => '',
      "target_tab" => ''
...
add_shortcode("elito_social", "elito_social_function");



/* Simple Images */
function elito_image_lists_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "custom_class" => '',
  ), $atts));
...
add_shortcode("elito_image_lists", "elito_image_lists_function");

/* Simple Image */
function elito_image_list_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "get_image" => '',
    "link" => '',
    "open_tab" => ''
...
add_shortcode("elito_image_list", "elito_image_list_function");

/* Simple Underline Link */
function elito_simple_link_function($atts, $content = NULL) {
  extract(shortcode_atts(array(
    "link_style" => '',
    "link_icon" => '',
    "link_text" => '',
  ...
  if ( $text_color || $text_size ) {
    ...
    $inline_style .= ( $text_size ) ? 'font-size:'. elito_core_check_px($text_size) .';' : '';
    $inline_style .= '}';
  }
  if ( $text_hover_color ) {
...
add_shortcode("elito_simple_link", "elito_simple_link_function");


/* Top bar info */
function elito_widget_topbars_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("elito_widget_topbars", "elito_widget_topbars_functions");

/* Top bar info */
function elito_widget_topbar_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info_icon" => '',
      "subtitle" => '',
      "title" => '',
...
add_shortcode("elito_widget_topbar", "elito_widget_topbar_function");


/*header Social */
function elito_header_socials_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "custom_text" => ''
   ), $atts));
...
add_shortcode("elito_header_socials", "elito_header_socials_function");

/* Address Info */
function elito_header_social_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "social_link" => '',
...
add_shortcode("elito_header_social", "elito_header_social_function");


/*header Middle Info */
function elito_header_middle_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("elito_header_middle_infos", "elito_header_middle_infos_function");

/*header Middle Info  */
function elito_header_middle_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_icon_color" => '',
      "address_text" => '',
...
add_shortcode("elito_header_middle_info", "elito_header_middle_info_function");
/*header Middle Info End */

/* Address Infos */
function elito_address_infos_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("elito_address_infos", "elito_address_infos_function");

/* Address Info */
function elito_address_info_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "address_style" => '',
      "info_icon" => '',
      "info_icon_color" => '',
...
add_shortcode("elito_address_info", "elito_address_info_function");

/* Useful Links */
function elito_useful_links_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "column_width" => '',
      "custom_class" => ''
   ), $atts));
...
add_shortcode("elito_useful_links", "elito_useful_links_function");

/* Useful Link */
function elito_useful_link_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "target_tab" => '',
      "title_link" => '',
      "link_title" => ''
...
add_shortcode("elito_useful_link", "elito_useful_link_function");

/* Footer Menus */
function elito_footer_menus_function($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => ''
   ), $atts));
...
add_shortcode("elito_footer_menus", "elito_footer_menus_function");

/* Footer Menu */
function elito_footer_menu_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "menu_title" => '',
      "menu_link" => '',
      "target_tab" => ''
...
add_shortcode("elito_footer_menu", "elito_footer_menu_function");

/* footer contact */
function elito_footer_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("elito_footer_contact_infos", "elito_footer_contacts_functions");

/*  footer contact  */
function elito_footer_contacts_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "icon" => '',
      "item_title" => '',
   ), $atts));
...
add_shortcode("elito_footer_contact_info", "elito_footer_contacts_function");


 /* footer Address */
function elito_addresss_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("elito_footer_address_item", "elito_addresss_functions");


 /* footer Addresss */
function elito_address_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "item" => '',
   ), $atts));
...
add_shortcode("elito_footer_address_items", "elito_address_functions");

/* Blockquote */
function elito_blockquote_function($atts, $content = true) {
  extract(shortcode_atts(array(
    "blockquote_style" => '',
    "text_size" => '',
    "custom_class" => '',
...
add_shortcode("elito_blockquote", "elito_blockquote_function");


/* Footer Logo Items */
function elito_widget_footer_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "footer_logo" => '',
      "desc" => '',
...
add_shortcode("footer_infos", "elito_widget_footer_infos_functions");


/* Footer Logo Item */
function elito_widget_footer_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "social_icon" => '',
      "social_link" => '',
   ), $atts));
...
add_shortcode("footer_info", "elito_widget_footer_infos_function");


/* Contact Infos */
function elito_widget_contact_infos_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "heading_title" => ''
   ), $atts));
...
add_shortcode("elito_widget_contact_infos", "elito_widget_contact_infos_functions");


/* Widget Contact Info */
function elito_widget_contact_infos_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "desc" => '',
...
add_shortcode("elito_widget_contact_info", "elito_widget_contact_infos_function");


/* Widget Contact Info */
function elito_widget_testimonial_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "subtitle" => '',
...
add_shortcode("elito_widget_testimonial", "elito_widget_testimonial_function");


/* Service Contact Widgets */
function elito_service_widget_contacts_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "contact_title" => '',
   ), $atts));
...
add_shortcode("elito_service_widget_contacts", "elito_service_widget_contacts_functions");

/* Service Contact Widget */
function elito_service_widget_contact_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "info" => '',
   ), $atts));
...
add_shortcode("elito_service_widget_contact", "elito_service_widget_contact_functions");

/* Download Widgets */
function elito_download_widgets_functions($atts, $content = true) {
   extract(shortcode_atts(array(
      "custom_class" => '',
   ), $atts));
...
add_shortcode("elito_download_widgets", "elito_download_widgets_functions");

/* Download Widget */
function elito_download_widget_functions($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "download_icon" => '',
      "title" => '',
      "link" => '',
...
add_shortcode("elito_download_widget", "elito_download_widget_functions");

/* Current Year - Shortcode */
if( ! function_exists( 'elito_current_year' ) ) {
  function elito_current_year() {
    return date('Y');
  }
  add_shortcode( 'elito_current_year', 'elito_current_year' );
}

/* Get Home Page URL - Via Shortcode */
if( ! function_exists( 'elito_home_url' ) ) {
  function elito_home_url() {
    return esc_url( home_url( '/' ) );
  }
  add_shortcode( 'elito_home_url', 'elito_home_url' );
}


/* About Widget */
function elito_widget_about_block_function($atts, $content = NULL) {
   extract(shortcode_atts(array(
      "custom_class" => '',
      "title" => '',
      "image_url" => '',
...
add_shortcode("elito_about_widget", "elito_widget_about_block_function");