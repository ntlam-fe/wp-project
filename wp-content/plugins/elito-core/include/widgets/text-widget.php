 ...
 */
class elito_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'text-widget',
      ELITO_THEME_NAME_PLUGIN . esc_html__( ': Text Widget', 'elito' ),
      array(
        'classname'   => 'text-widget',
        'description' => ELITO_THEME_NAME_PLUGIN . esc_html__( ' widget that displays contents.', 'elito' )
      )
    );
  }
...
add_action( 'widgets_init', function() { register_widget( "elito_text_widget" ); } );